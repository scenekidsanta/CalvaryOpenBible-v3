...
namespace CalvaryOpebBibleWebsite.Controllers
{
    public class ContactController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactID,Name,Address,Telphone,Email")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactID,Name,Address,Telphone,Email")] Contact contact)
        {
            if (ModelState.IsValid)
            {
