...
namespace CalvaryOpebBibleWebsite.Controllers
{
    public class ContactController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContactID,Address,Telphone,Email,Name")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ContactID,Address,Telphone,Email,Name")] Contact contact)
        {
            if (ModelState.IsValid)
            {
